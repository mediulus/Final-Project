...
[@UserInfoConcept.ts](../../src/concepts/UserInfoConcept/UserInfoConcept.ts)

# prompt: Using the concept implementation of the UserInfo concept in UserInfoConcept.ts, follow the prompt in api-extraction-from-code.
