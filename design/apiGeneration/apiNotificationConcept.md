...
[@NotificationConcept.ts](../../src/concepts/NotificationConcept/NotificationConcept.ts)

# prompt: Using the concept implementation of the Notification concept in NotificationConcept.ts, follow the prompt in api-extraction-from-code.
