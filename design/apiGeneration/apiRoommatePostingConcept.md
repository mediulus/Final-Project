...
[@api-extraction-from-code.md](../../design/tools/api-extraction-from-code.md)

[@RoommatePostingConcept.ts](../../src/concepts/RoommatePostingConcept/RoommatePostingConcept.ts)

# prompt: Using the concept implementation of the RoommatePosting concept in RoommatePostingConcept.ts, follow the prompt in api-extraction-from-code.
